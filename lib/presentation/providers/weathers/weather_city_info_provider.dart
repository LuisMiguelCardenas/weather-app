...
final weatherCityInfoProvider = StateNotifierProvider<CityMapNotifier,Map<String,WeatherData>>((ref) {
...
typedef GetCityDescriptionCallback = Future<WeatherData> Function(String cityName);
